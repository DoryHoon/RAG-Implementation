...
RAG 개발을 위한 기초 단계부터 Advanced RAG: Query Translation 단계를 0번 파일부터 n번 파일 순서로 프로그램을 개발하였습니다.
n번 기준 가장 최근 프로젝트임을 참고하시면 됩니다. 각 프로젝트에 대한 README 파일 또는 Presentation & Video는 code 구현 및 프로젝트 설명 단계를 위해 첨부하였습니다.

Notes explanation은 기초적인 RAG 개발 형식 설명을 참고하시면 됩니다.


## 2: RAG Chatbot 

RAG 개발 상용화를 위해 Streamlit을 활용하여 application 단계 실행 및 테스트를 진행하였습니다. BASIC-RAG와 마찬가지로 0번 파일에서 n번 파일 순서로 프로그램을 개발하였습니다.
...
```
<img width="652" height="276" alt="image" src="https://github.com/user-attachments/assets/ce124ac0-4da4-447c-92a4-872de3a9de62" />
...
===============================================
  ...
  [최종 답변]
```
<img width="642" height="292" alt="image" src="https://github.com/user-attachments/assets/c640b684-c92f-495c-8ad4-b17c01d92c87" />
